...
@Component({
  selector: 'app-fourteen-participants-bracket',
  templateUrl: './fourteen-participants-bracket.component.html',
  styleUrls: ['./fourteen-participants-bracket.component.scss'],
})
export class FourteenParticipantsBracketComponent implements OnInit {
  ...
  createMatches() {
    ...
    const eights6: matchToCreateI = {
      bracketId: this.bracket.bracketId,
      blueCompetitorId: bracketSort3[10].competitorId,
    ...
    const eights7: matchToCreateI = {
      ...
      redCompetitorId: bracketSort3[12].competitorId,
      round: 'eights7',
    };
    this.postMatch(eights7);
    const eights8: matchToCreateI = {
      bracketId: this.bracket.bracketId,
      blueCompetitorId: bracketSort3[13].competitorId,
      redCompetitorId: bracketSort3[13].competitorId,
      round: 'eights8',
    };
