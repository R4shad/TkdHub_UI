...
@Component({
  selector: 'app-bracket-results',
  templateUrl: './bracket-results.component.html',
  styleUrls: ['./bracket-results.component.scss'],
})
export class BracketResultsComponent implements OnInit {
