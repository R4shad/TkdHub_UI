...
@Component({
  selector: 'app-thirteen-participants-bracket',
  templateUrl: './thirteen-participants-bracket.component.html',
  styleUrls: ['./thirteen-participants-bracket.component.scss'],
})
export class ThirteenParticipantsBracketComponent implements OnInit {
  ...
  createMatches() {
    ...
    const eights5: matchToCreateI = {
      bracketId: this.bracket.bracketId,
      blueCompetitorId: bracketSort3[7].competitorId,
    ...
    const eights8: matchToCreateI = {
      bracketId: this.bracket.bracketId,
      blueCompetitorId: bracketSort3[12].competitorId,
